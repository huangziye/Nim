...
import com.hzy.nim.contact.activity.RobotProfileActivity;
import com.hzy.nim.contact.activity.UserProfileActivity;
import com.hzy.nim.session.action.*;
import com.hzy.nim.session.activity.AckMsgInfoActivity;
import com.hzy.nim.session.activity.MessageHistoryActivity;
import com.hzy.nim.session.activity.MessageInfoActivity;
import com.hzy.nim.session.extension.*;
import com.hzy.nim.session.redpacket.NIMRedPacketClient;
import com.hzy.nim.session.search.SearchMessageActivity;
import com.hzy.nim.session.viewholder.*;
...
import com.hzy.uikit.api.wrapper.NimMessageRevokeObserver;
...
import com.hzy.uikit.business.session.viewholder.MsgViewHolderUnknown;
import com.hzy.uikit.business.team.model.TeamExtras;
import com.hzy.uikit.business.team.model.TeamRequestCode;
...
public class SessionHelper {
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor) {
        LoginInfo loginInfo = (LoginInfo) ACache.get(context).getAsObject("loginInfo");
        if (null != loginInfo && !loginInfo.getAccount().equals(account)) {
