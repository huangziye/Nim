...
import com.hzy.nim.session.extension.RedPacketAttachment;
import com.hzy.nim.session.redpacket.NIMOpenRpCallback;
...
import com.hzy.uikit.business.session.module.list.MsgAdapter;
