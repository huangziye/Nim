package com.hzy.nim.session.redpacket;
 ...
 * 4.红包消息、拆红包消息分别使用自定义消息，参考 {@link com.hzy.nim.session.extension.RedPacketAttachment}、
 * {@link com.hzy.nim.session.extension.RedPacketOpenedAttachment},在调用金融魔方接口发送红包成功之后，发送
