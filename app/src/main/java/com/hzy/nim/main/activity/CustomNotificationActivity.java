...
import com.hzy.nim.main.helper.CustomNotificationCache;
import com.hzy.nim.main.viewholder.CustomNotificationViewHolder;
...
public class CustomNotificationActivity extends UI implements TAdapterDelegate {
    ...
    private void selectCustomNotificationTarget(boolean team) {
        ...
        option.title = this.getString(R.string.select_custom_notification_target);
        option.multi = false;
    ...
    private void sendCustomNotification(String account, String content) {
        ...
        notification.setFromAccount(NimUIKit.getAccount());
