...
import com.hzy.nim.main.activity.WelcomeActivity;
import com.hzy.uikit.api.wrapper.MessageRevokeTip;
import com.hzy.uikit.api.wrapper.NimUserInfoProvider;
...
//        options.mNosTokenSceneConfig = createNosTokenScene();
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.color_activity_blue_bg);
        // 通知铃声的uri字符串
