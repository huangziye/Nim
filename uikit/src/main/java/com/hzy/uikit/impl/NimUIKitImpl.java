...
import com.hzy.uikit.api.UIKitInitStateListener;
import com.hzy.uikit.api.UIKitOptions;
import com.hzy.uikit.api.model.chatroom.ChatRoomMemberChangedObservable;
import com.hzy.uikit.api.model.chatroom.ChatRoomProvider;
import com.hzy.uikit.api.model.chatroom.ChatRoomSessionCustomization;
import com.hzy.uikit.api.model.contact.ContactChangedObservable;
import com.hzy.uikit.api.model.contact.ContactEventListener;
import com.hzy.uikit.api.model.contact.ContactProvider;
import com.hzy.uikit.api.model.location.LocationProvider;
import com.hzy.uikit.api.model.main.CustomPushContentProvider;
import com.hzy.uikit.api.model.main.LoginSyncDataStatusObserver;
import com.hzy.uikit.api.model.main.OnlineStateChangeObservable;
import com.hzy.uikit.api.model.main.OnlineStateContentProvider;
import com.hzy.uikit.api.model.recent.RecentCustomization;
import com.hzy.uikit.api.model.robot.RobotInfoProvider;
import com.hzy.uikit.api.model.session.SessionCustomization;
import com.hzy.uikit.api.model.session.SessionEventListener;
import com.hzy.uikit.api.model.team.TeamChangedObservable;
import com.hzy.uikit.api.model.team.TeamProvider;
import com.hzy.uikit.api.model.user.IUserInfoProvider;
import com.hzy.uikit.api.model.user.UserInfoObservable;
import com.hzy.uikit.business.chatroom.fragment.ChatRoomMessageFragment;
import com.hzy.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderBase;
import com.hzy.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
import com.hzy.uikit.business.contact.selector.activity.ContactSelectActivity;
import com.hzy.uikit.business.preference.UserPreferences;
import com.hzy.uikit.business.session.activity.P2PMessageActivity;
import com.hzy.uikit.business.session.activity.TeamMessageActivity;
import com.hzy.uikit.business.session.audio.MessageAudioControl;
import com.hzy.uikit.business.session.emoji.StickerManager;
import com.hzy.uikit.business.session.module.MsgForwardFilter;
import com.hzy.uikit.business.session.module.MsgRevokeFilter;
import com.hzy.uikit.business.session.viewholder.MsgViewHolderBase;
import com.hzy.uikit.business.session.viewholder.MsgViewHolderFactory;
import com.hzy.uikit.business.team.activity.AdvancedTeamInfoActivity;
import com.hzy.uikit.business.team.activity.NormalTeamInfoActivity;
import com.hzy.uikit.common.util.log.LogUtil;
import com.hzy.uikit.common.util.storage.StorageType;
import com.hzy.uikit.common.util.storage.StorageUtil;
import com.hzy.uikit.common.util.sys.ScreenUtil;
import com.hzy.uikit.impl.cache.ChatRoomCacheManager;
import com.hzy.uikit.impl.cache.DataCacheManager;
import com.hzy.uikit.impl.customization.DefaultContactEventListener;
import com.hzy.uikit.impl.customization.DefaultP2PSessionCustomization;
import com.hzy.uikit.impl.customization.DefaultRecentCustomization;
import com.hzy.uikit.impl.customization.DefaultTeamSessionCustomization;
import com.hzy.uikit.impl.provider.*;
import com.hzy.uikit.support.glide.ImageLoaderKit;
