package com.hzy.uikit.common.util.media;
...
import com.hzy.uikit.business.session.viewholder.MsgViewHolderThumbBase;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            float rotate;
            String mimeType = com.hzy.uikit.common.media.picker.util.BitmapUtil.getImageType(srcFile.getAbsolutePath());
