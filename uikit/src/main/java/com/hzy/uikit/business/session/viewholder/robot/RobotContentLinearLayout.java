package com.hzy.uikit.business.session.viewholder.robot;
...
import com.hzy.uikit.business.robot.model.RobotBotContent;
import com.hzy.uikit.business.robot.model.RobotResponseContent;
import com.hzy.uikit.business.robot.parser.elements.base.Element;
import com.hzy.uikit.business.robot.parser.elements.element.ImageElement;
import com.hzy.uikit.business.robot.parser.elements.element.TextElement;
import com.hzy.uikit.business.robot.parser.elements.group.LinkElement;
import com.hzy.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.hzy.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.hzy.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
